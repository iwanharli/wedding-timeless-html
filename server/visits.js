...
const migrate = (async () => {
  ...
  `)
  await pool.query('ALTER TABLE page_visits ADD COLUMN IF NOT EXISTS ip_address TEXT')
  await pool.query('ALTER TABLE page_visits ADD COLUMN IF NOT EXISTS user_agent TEXT')
  await pool.query('ALTER TABLE page_visits ADD COLUMN IF NOT EXISTS device_type TEXT')
  await pool.query('ALTER TABLE page_visits ADD COLUMN IF NOT EXISTS browser_name TEXT')
  await pool.query('ALTER TABLE page_visits ADD COLUMN IF NOT EXISTS os_name TEXT')
