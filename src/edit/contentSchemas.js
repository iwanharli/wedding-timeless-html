export const CONTENT_SECTIONS = [
  ...
  // ── Profile Intro ───────────────────────────────────────
  {
    ...
    fields: [
      { path: 'profile.quoteText', label: 'Kutipan / Quote', type: 'textarea', hint: 'Bisa berupa ayat suci, lirik lagu, puisi, atau kalimat inspiratif' },
      { path: 'profile.quoteSource', label: 'Sumber / Penulis', type: 'text', hint: 'Contoh: Gustave Flaubert, atau 1 Korintus 13:4, atau dikosongkan' },
